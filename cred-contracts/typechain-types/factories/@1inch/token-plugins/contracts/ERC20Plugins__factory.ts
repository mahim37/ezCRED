...
import type {
  ERC20Plugins,
  ERC20PluginsInterface,
} from "../../../../@1inch/token-plugins/contracts/ERC20Plugins";
...
export class ERC20Plugins__factory {
  static readonly abi = _abi;
  static createInterface(): ERC20PluginsInterface {
    return new Interface(_abi) as ERC20PluginsInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ERC20Plugins {
    return new Contract(address, _abi, runner) as unknown as ERC20Plugins;
  }
}
