...
export interface IERC20PluginsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addPlugin"
      | "allowance"
...
export interface IERC20Plugins extends BaseContract {
  connect(runner?: ContractRunner | null): IERC20Plugins;
  waitForDeployment(): Promise<this>;

  interface: IERC20PluginsInterface;
