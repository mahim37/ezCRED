...
// File @1inch/token-plugins/contracts/Plugin.sol@v1.2.1
...
// File contracts/libs/Mathlib.sol
...
// File contracts/libs/AYPCalc.sol
...
contract WETH is IWETH, ERC20Plugins {
    int256 AYP;
    int256 _totalSupply;
    struct TokenInfo {
        address contractAddr;
    ...
    function getTokenSupply() public view returns (int256) {
        // require(msg.sender == owner(), "Not authorized to update AYP");
        // tokens[assetAddress].tokenAYP = newAYP;
        return _totalSupply;
    }
    ...
    // function maxPluginsPerAccount()
    //     external
    //     view
    //     override
    //     returns (uint256 pluginsLimit)
    // {}

    // function pluginCallGasLimit()
    //     external
    //     view
    //     override
