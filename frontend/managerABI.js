const abi = [
  ...
  { inputs: [], name: "InvalidCalldataLength", type: "error" },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint64", name: "flaggedAt", type: "uint64" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "plugin", type: "address" },
      { internalType: "bool", name: "requiresRootAccess", type: "bool" },
      { internalType: "bool", name: "providedValue", type: "bool" },
    ],
  ...
  { inputs: [], name: "ZeroPageSizeNotAllowed", type: "error" },
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    outputs: [
      { internalType: "bytes32", name: "moduleTxHash", type: "bytes32" },
    ],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "address", name: "prevPlugin", type: "address" },
      { internalType: "address", name: "plugin", type: "address" },
    ],
    name: "disablePlugin",
    outputs: [],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "plugin", type: "address" },
      { internalType: "bool", name: "allowRootAccess", type: "bool" },
    ],
    name: "enablePlugin",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    name: "enabledPlugins",
    outputs: [
      { internalType: "bool", name: "rootAddressGranted", type: "bool" },
      { internalType: "address", name: "nextPluginPointer", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "address", name: "hooksAddress", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      { internalType: "address", name: "functionHandler", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "address", name: "hooksAddress", type: "address" },
      { internalType: "bytes", name: "preCheckData", type: "bytes" },
    ],
    stateMutability: "view",
    type: "function",
  },
